...
class StrassenmusicService {
    ...
    private val addBookingPage =
        "https://www.dresden.de/apps_ext/StrassenmusikApp_en/applicant?3-1.IBehaviorListener.0-bookingContainer-listBookings-responsiveTable-bottomLinksContainer-bottomLinks-0-bottomLinkButton&_="
    ...
    fun addBooking(slot: Slot, cookies: String, refer:String) {
        val page = HttpHelper.getPage(
            url = addBookingPage + "${System.currentTimeMillis()}",
            cookies = cookies,
        )
        val document = Jsoup.parse(page)
    }
